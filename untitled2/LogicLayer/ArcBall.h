...
#include <math.h>
#ifndef __OpenGL_GL__ 
#include "GL/gl.h"
#define __OpenGL_GL__
#endif
...
//Math functions
    ...
    {
		NewObj->s.M01 = NewObj->s.M02 = NewObj->s.M03 = 0;
		NewObj->s.M10 = NewObj->s.M12 = NewObj->s.M13 = 0;
		NewObj->s.M20 = NewObj->s.M21 = NewObj->s.M23 = 0;
		NewObj->s.M30 = NewObj->s.M31 = NewObj->s.M32 = 0;
		NewObj->s.M00 = NewObj->s.M11 = NewObj->s.M22 = NewObj->s.M33 = 1.0;
    }
        ...
        public:
            ...
            void    setBounds(GLfloat NewWidth, GLfloat NewHeight)
            {
                if((NewWidth < 1.0f) || (NewHeight < 1.0f))
					NewWidth = 40,NewHeight = 30;
				//if(NewWidth>NewHeight)
					//NewWidth = NewHeight;

                //Set adjustment factor for width/height
                //this->AdjustWidth  = NewWidth  - 1.0f;
                //this->AdjustHeight = NewHeight - 1.0f;
				this->AdjustWidth  = NewWidth;
